<script>
  import Gjennomsnitter from '$lib/components/Gjennomsnitter.svelte'
  // import Select from 'svelte-select'

  import { minidaySettings, minidayCharts } from '$lib/utils/store.js'

  import { countries as items, regions } from '$lib/utils/searchcountries.js'
  import norskeRegioner from '$lib/data/countries/no_regions.json'
  ...
  <div class="selectregions">
    ...
    <div class="subregions">
      ...
      {#if subregions}
        ...
        {/each}
        <button
          on:click={() => (subregions = !subregions)}

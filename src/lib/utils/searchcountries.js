import no from '$lib/data/countries/countries_no.json'
import de from '$lib/data/countries/countries_de.json'
import fr from '$lib/data/countries/countries_fr.json'
import en from '$lib/data/countries/countries_en.json'

import list from '$lib/data/countries/jhcountries.json'

import regionData from '$lib/data/countries/countryandregionlist.json'
...
let filtered = unfiltered.filter((f) => list.map((v) => v).includes(f.alpha3))
